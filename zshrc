...
# Path to your oh-my-zsh installation.
  export ZSH="/home/arjones/.oh-my-zsh"
...
then
    ...
    [[ -n "${precmd_functions[(r)pantheon_terminal_command_competion_callback]}" ]] || {
        precmd_functions[$(($#precmd_functions+1))]=pantheon_terminal_command_competion_callback
    }
